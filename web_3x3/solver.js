...
// ---------- Cau hinh bai toan ----------
export const W = 3, H = 3, NCELL = W * H;   // luoi 3 cot x 3 hang = 9 o
export const START_CELL = 0;
export const DIRTY_CELLS = [2, 6];
...
export const C_REF = {
  BFS:   { solLen: 8, expanded: 26,   generated: 73, peakFrontier: 6 },
  DFS:   { solLen: 8, expanded: 8 },
  IDS:   { solLen: 8, expanded: 260 },
  "A*h1":{ solLen: 8, expanded: 27 },
  "A*h2":{ solLen: 8, expanded: 19 },
};
